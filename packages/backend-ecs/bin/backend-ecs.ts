...
const subnetAvailabilityZone = cdk.Fn.importValue('gbraver-burst-vpc:PulicNetAvailabilityZone');
const subnetId = cdk.Fn.importValue('gbraver-burst-vpc:PulicSubnetId');
...
new BackendEcsStack(app, `${service}-${stage}-backend-ecs`, {service, stage, vpcId, subnetAvailabilityZone, subnetId,
