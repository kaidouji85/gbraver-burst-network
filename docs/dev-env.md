...
| 名前                                          | 種類         | 値                                                                                                |
| --------------------------------------------- | ------------ | ------------------------------------------------------------------------------------------------- |
| /GbraverBurst/dev/service                     | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) SERVICE を参照                        |
| /GbraverBurst/dev/wsSignalService             | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) WS_SIGNAL_SERVICE を参照              |
| /GbraverBurst/dev/backendCloudfrontService    | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) BACKEND_CLOUDFRONT_SERVICE を参照     |
| /GbraverBurst/dev/stage                       | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) STAGE を参照                          |
| /GbraverBurst/dev/backendCloudfrontDomainName | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) BACKEND_CLOUDFRONT_DOMAIN_NAME を参照 |
| /GbraverBurst/dev/backendCloudfrontCertArn    | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) BACKEND_CLOUDFRONT_CERT_ARN を参照    |
| /GbraverBurst/dev/backendCloudfrontWebAclArn  | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) BACKEND_CLOUDFRONT_WEB_ACL_ARN を参照 |
| /GbraverBurst/dev/wsApiDomainName             | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) WS_API_DOMAIN_NAME を参照             |
| /GbraverBurst/dev/wsSignalDomainName          | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) WS_SIGNAL_DOMAIN_NAME を参照          |
| /GbraverBurst/dev/wsSignalCertArn             | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) WS_SIGNAL_CERT_ARN を参照             |
| /GbraverBurst/dev/wsApiCertArn                | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) WS_API_CERT_ARN を参照                |
| /GbraverBurst/dev/webrtcHelperCorsOrigin      | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) WEBRTC_HELPER_CORS_ORIGIN を参照      |
| /GbraverBurst/dev/cognitoUserPoolId           | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) COGNITO_USER_POOL_ID を参照           |
| /GbraverBurst/dev/cognitoClientId             | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) COGNITO_CLIENT_ID を参照              |
| /GbraverBurst/dev/matchMakeEcrRepositoryName  | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) MATCH_MAKE_ECR_REPOSITORY_NAME を参照 |
| /GbraverBurst/dev/dockerUser                  | SecureString | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) DOCKER_USER を参照                    |
| /GbraverBurst/dev/dockerToken                 | SecureString | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) DOCKER_TOKEN を参照                   |
| /GbraverBurst/dev/vpcSubnetCount              | String       | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) VPC_SUBNET_COUNT を参照               |
...
| ------------------------------------ | --------------------------------------------------------------------------------------- |
| /GbraverBurst/dev/coturnSharedSecret | [ローカル環境マニュアル/環境変数定義の定義](./local-env.md) COTURN_SHARED_SECRET を参照 |
